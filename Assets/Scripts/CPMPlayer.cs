...
public class CPMPlayer : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //disables jump so player can get it later
        hasJumpBoots = false;   
    }
   ...
   \*******************************************************************************************************/
    ...
    private void QueueJump()
    {
        ...
        if (Input.GetButtonDown("Jump") && !wishJump && hasJumpBoots)
            wishJump = true;
    ...
    */
    ...
    //camera bobbing,tilting,sway,etc
    void cameraFeel()
    {
        var waveslice = 0.0f;
        ...
        var newHeadPosition = playerView.localPosition;
        ...
        //tilting
        var tilt = -1 * horizontal * MaxTilt;

        //_currentTilt = _currentTilt.MoveTowards(tilt, TiltSpeed * Time.deltaTime);

        _currentTilt = Mathf.MoveTowards(_currentTilt, tilt, TiltSpeed * Time.deltaTime);

        var rot = transform.localRotation;
        playerView.localRotation *= Quaternion.AngleAxis(_currentTilt, Vector3.forward);

        playerView.localPosition = newHeadPosition;
